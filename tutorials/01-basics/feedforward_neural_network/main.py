...
class NeuralNet(nn.Module):
    def __init__(self, input_size, hidden_size, num_classes):
        super(NeuralNet, self).__init__() #The super(NeuralNet, self).__init__() line calls the __init__ method of the parent class (nn.Module) to properly initialize the NeuralNet object
